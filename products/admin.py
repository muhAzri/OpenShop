...
class ProductAdmin(admin.ModelAdmin):
    list_display = [
        'name', 'sku', 'shop', 'location', 'category', 
        'price', 'discount', 'stock', 'is_available', 'is_delete'
    ]
    list_filter = [
        'is_available', 'is_delete', 'category', 'shop', 'location'
    ]
    ...
    def soft_delete_selected(self, request, queryset):
        ...
        self.message_user(
            request, 
            f'{count} product(s) were successfully soft deleted.'
        )
    ...
    def get_form(self, request, obj=None, **kwargs):
        ...
        if obj and obj.is_delete:
            form.base_fields['is_delete'].help_text = "This product is soft deleted. Uncheck to restore."
        return form
